...
2026-09-23雷达静止对照：用户尺量中心到左墙1.150/1.670米，两组42/46帧拟合1.162/1.689米，偏大约1.2/1.9厘米；墙线角4.50°/5.80°不一致，未应用固定安装角或量程修正，全程未发送控制命令。[记录与限制](docs/车辆尺寸与几何来源.md#左侧墙面参照2026-09-23两组距离对照)。
