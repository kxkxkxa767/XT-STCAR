...
2026-09-23雷达静止参照：左后轮外侧距平行左墙1米，42帧显示扫描拟合雷达到墙约1.162米、墙线相对雷达前向约4.5°；用户补量雷达中心距墙1.150米，首组拟合偏大约1.2厘米；待另一距离复核，未修改外参或发送运动命令。[记录与限制](docs/车辆尺寸与几何来源.md#左侧墙面参照2026-09-23首组已补尺量)。
