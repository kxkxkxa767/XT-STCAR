...
晚间追加1550/2秒和1600/0.3秒均由用户确认未动；1600/2秒用户估计前进4–5米并确认停住；1620/0.3秒前进不到1米并停住复位；1620/2秒用户观察向左偏（原因未定），已回中补发停止帧，用户要求结束测试。当前场地扫描未通过质量门，最高速度仍未测。[追加测试记录](docs/vehicle-speed-probe-validation.json)。
