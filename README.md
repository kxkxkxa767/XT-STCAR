...
2026-09-23雷达粗修正已安装：左/右墙三组尺量后，按用户要求采用量程−2厘米、顺时针5°修正；驾驶台画面与保存数据已生效，保留原始扫描，原点仍是雷达中心。未改导航外参或质量门、未驱动车辆。追加后墙尺量1.155米，现有修正后拟合1.1576米，本组无需新增修正。[三组对照与回退](docs/车辆尺寸与几何来源.md#追加右墙对照与启用粗修正2026-09-23)。
