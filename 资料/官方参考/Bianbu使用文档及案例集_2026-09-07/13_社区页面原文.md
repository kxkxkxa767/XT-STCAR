...
更多信息请参考：[外设驱动](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/buildroot/k1_buildroot/device/peripheral_driver)
...
内核编译的详细教程参考：[内核编译](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/bianbu/development/kernel_compile.md)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/pins_mutex.png)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/kernel_deb.png)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output1.png)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output2.png)

PWM 子系统会暴露设备节点

运行： `ls -l /sys/class/pwm/pwmchip*/device`

![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output3.png)
...
其他功能的配置可以参考：[外设驱动](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/buildroot/k1_buildroot/device/peripheral_driver)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output4.png)

使用 file 命令查看文件属性，确保为 RISC-V 的内核模块文件：

![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output5.png)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output6.png)
...
![](https://cdn-resource.spacemit.com/competition/docs-events/zh/竞赛教程/01_Bianbu_使用文档及案例集/images/output7.png)
